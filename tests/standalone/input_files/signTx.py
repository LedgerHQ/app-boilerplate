...
testsByron: List[SignTxTestCase] = [
    SignTxTestCase("Sign_tx_with_third-party_Byron_mainnet_output",
                   Transaction(Mainnet,
                               [inputs["utxoByron"]],
    ...
    SignTxTestCase("Sign_tx_with_third-party_Byron_Daedalus_mainnet_output",
                   Transaction(Mainnet,
                               [inputs["utxoByron"]],
    ...
    SignTxTestCase("Sign_tx_with_third-party_Byron_testnet_output",
                   Transaction(Testnet,
                               [inputs["utxoByron"]],
...
testsShelleyNoCertificates: List[SignTxTestCase] = [
    ...
    SignTxTestCase("Sign_tx_with_non-reasonable_account_and_address",
                   Transaction(Mainnet,
...
testsAllegra: List[SignTxTestCase] = [
    ...
    SignTxTestCase("Sign_tx_with_no_ttl_,_but_with_validity_interval_start",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalShelleyBaseKeyhashKeyhash"]],
                               42,
...
testsMary: List[SignTxTestCase] = [
    ...
    SignTxTestCase("Sign_tx_with_zero_fee,_TTL_and_validity_interval_start",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["internalBaseWithStakingPath"]],
                               0,
...
testsBabbageTrezorComparison: List[SignTxTestCase] = [
    SignTxTestCase("Full_test_for_trezor_feature_parity_-_Babbage_elements_(Plutus)",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
    ...
    SignTxTestCase("Full_test_for_trezor_feature_parity_-_Babbage_elements_(ordinary)",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
...
testsConwayVotingProcedures: List[SignTxTestCase] = [
    SignTxTestCase("Sign_tx_with_voting_procedures,_COMMITTEE_KEY_PATH_voter",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
    ...
    SignTxTestCase("Sign_tx_with_voting_procedures,_DREP_KEY_PATH_voter",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
    ...
    SignTxTestCase("Sign_tx_with_voting_procedures,_STAKE_POOL_KEY_PATH_voter",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
    ...
    SignTxTestCase("Sign_tx_with_voting_procedures,_COMMITTEE_KEY_HASH_voter",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
    ...
    SignTxTestCase("Sign_tx_with_voting_procedures,_COMMITTEE_SCRIPT_HASH_voter",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
    ...
    SignTxTestCase("Sign_tx_with_voting_procedures,_DREP_KEY_HASH_voter",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
    ...
    SignTxTestCase("Sign_tx_with_voting_procedures,_DREP_SCRIPT_HASH_voter",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
    ...
    SignTxTestCase("Sign_tx_with_voting_procedures,_STAKE_POOL_KEY_HASH_voter",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
    ...
    SignTxTestCase("Sign_tx_with_voting_procedures_single_voter_multiple_votes",
                   Transaction(Mainnet,
                               ...
                               votingProcedures=[VoterVotes(Voter(VoterType.DREP_KEY_PATH,
                                                            ...
                                                            [vote1, vote2, vote3])]),
                   TransactionSigningMode.ORDINARY_TRANSACTION,
                   ""),
                   ...
                   Transaction(Mainnet,
                               ...
                               votingProcedures=[VoterVotes(Voter(VoterType.COMMITTEE_KEY_PATH,
                                                ...
                                                VoterVotes(Voter(VoterType.STAKE_POOL_KEY_PATH,
                                                            ...
                                                            [vote3])]),
                   TransactionSigningMode.ORDINARY_TRANSACTION,
                   ""),
    SignTxTestCase("Sign_tx_with_voting_procedures_multiple_voters_multiple_votes",
                   Transaction(Mainnet,
                               ...
                               votingProcedures=[VoterVotes(Voter(VoterType.DREP_KEY_PATH,
                                                                 "m/1852'/1815'/0'/3/0"),
                                                            [vote1, vote2]),
                                                VoterVotes(Voter(VoterType.COMMITTEE_SCRIPT_HASH,
                                                                 "8afd028b504c3668102b129b37a86c09a2872f76741dc7a68e2149c8"),
                                                            [vote2, vote3])]),
                   TransactionSigningMode.PLUTUS_TRANSACTION,
                   ""),
]
...
testsCVoteRegistrationCIP36: List[SignTxTestCase] = [
   ...
   SignTxTestCase("Sign_tx_with_CIP36_registration_with_unusual_vote_key_path",
                   ...
                   nano_skip=True),
    SignTxTestCase("Sign_tx_with_CIP36_registration_with_third-party_payment_address",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["internalBaseWithStakingPath"]],
                               42,
...
testsBabbage: List[SignTxTestCase] = [
    SignTxTestCase("Sign_tx_with_short_inline_datum_in_output_with_tokens",
                   ...
                   nano_skip=True),
    SignTxTestCase("Sign_tx_with_long_inline_datum_(480_B)_in_output",
                   Transaction(Testnet_legacy,
                               [inputs["utxoShelley"]],
                   ...
                   nano_skip=True),
    SignTxTestCase("Sign_tx_with_long_inline_datum_(304_B)_in_output_with_tokens",
                   Transaction(Testnet_legacy,
                               [inputs["utxoShelley"]],
                   ...
                   nano_skip=True),
    # reference script
    SignTxTestCase("Sign_tx_with_datum_hash_and_short_ref._script_in_output",
                   Transaction(Testnet_legacy,
                               [inputs["utxoShelley"]],
                   ...
                   nano_skip=True),
    SignTxTestCase("Sign_tx_with datum hash_and_ref._script_(240_B)_in_output_in_Babbage_format",
                   Transaction(Testnet_legacy,
                               [inputs["utxoShelley"]],
                   ...
                   nano_skip=True),
    SignTxTestCase("Sign_tx_with datum_hash_and_script_reference_(304_B)_in_output_as_map",
                   Transaction(Testnet_legacy,
                               [inputs["utxoShelley"]],
    ...
    SignTxTestCase("Sign_tx_with_change_collateral_output_as_map_with_total_collateral",
                   ...
                   nano_skip=True),
    SignTxTestCase("Sign_tx_with_third-party_collateral_output_as_map_without_total_collateral",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["multiassetManyTokensBabbage"]],
                               42,
    ...
    SignTxTestCase("Sign_tx_with_third-party_collateral_output_as_map_with_total_collateral",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["multiassetManyTokensBabbage"]],
                               42,
...
poolRegistrationOwnerTestCases: List[SignTxTestCase] = [
     ...
     SignTxTestCase("Witness_valid_multiple_mixed_owners_ipv4_relay_pool_registration",
                   ...
                   nano_skip=True),
     SignTxTestCase("Witness valid_multiple_mixed_owners_mixed_ipv4,_single_host_relays_pool_registration",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                               [outputs["externalShelleyBaseKeyhashKeyhash"]],
                               42,
...
transactionInitRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Non-mainnet_protocol_magic",
    ...
    SignTxTestCase("Pool_registration_(operator)_-_too_few_certificates",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(owner)_-_too_few_certificates",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(operator)_-_too_many_certificates",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(owner)_-_too_many_certificates",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(operator)_-_too_many_withdrawals",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(owner)_-_too_many_withdrawals",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(operator)_-_mint_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(owner)_-_mint_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    # collateral inputs
    SignTxTestCase("Ordinary_tx_-_collateral_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Multisig_tx_-_collateral_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(operator)_-_collateral_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(owner)_-_collateral_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    # required signers
    SignTxTestCase("Pool_registration_(operator)_-_required_signers_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(owner)_-_required_signers_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
    ...
    SignTxTestCase("Ordinary_tx_-_collateral_output_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Multisig_tx_-_collateral_output_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(operator)_-_collateral_output_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(owner)_-_collateral_output_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
    ...
    SignTxTestCase("Ordinary_tx_-_total_collateral_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Multisig_tx_-_total_collateral_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(operator)_-_total_collateral_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(owner)_-_total_collateral_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
    ...
    SignTxTestCase("Ordinary_tx_-_reference_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Multisig_tx_-_reference_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(operator)_-_reference_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_registration_(owner)_-_reference_inputs_included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
...
addressParamsRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Reward_address_-_key",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Reward_address_-_script",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("No_spending_path_-_Ordinary_Tx_1",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("No_spending_path_-_Ordinary_Tx_2",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_operator_-_spending_choice_not_path",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Multisig_-_unconditionally",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["internalBaseWithStakingPath"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_owner_-_unconditionally",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["internalBaseWithStakingPath"]],
                               42,
...
certificateStakingRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Script_hash_in_Ordinary_Tx",
                   ...
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    # TODO: Debug navigation
    # SignTxTestCase("Non-staking_path_in_Ordinary_Tx",
    #                Transaction(Mainnet,
    #                            [inputs["utxoShelley"]],
    #                            [outputs["externalByronMainnet"]],
    #                            42,
...
certificateStakePoolRetirementRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Non-pool_cold_key_in_Ordinary_Tx",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
...
withdrawalRejectTestCases: List[SignTxTestCase] = [
    ...
    #                "",
    #                expected_sw=StatusWord.SWO_INVALID_DATA),
    # SignTxTestCase("Non-staking_path_as_stake_credential_in_Plutus_Tx",
    #                Transaction(Mainnet,
    #                            [inputs["utxoShelley"]],
    #                            [outputs["externalByronMainnet"]],
    #                            42,
    ...
    SignTxTestCase("Script_hash_as_stake_credential_in_Ordinary_Tx",
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Non-staking_path_as_stake_credential_in_Ordinary_Tx",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
...
witnessRejectTestCases: List[SignTxTestCase] = [
    ...
    #                expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED,
    #                additionalWitnessPaths=["m/1854'/1815'/0'"]),
    # SignTxTestCase("Multisig_account_path_in_Pool_Registration_(Owner)_Tx",
    #                Transaction(Mainnet,
    #                            [inputs["utxoMultisig"]],
    #                            [outputs["externalByronMainnet"]],
    #                            42,
    ...
    #                expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED,
    #                additionalWitnessPaths=["m/1854'/1815'/0'"]),
    # SignTxTestCase("Ordinary_spending_path_in_Pool_Registration_(Owner)_Tx",
    #                Transaction(Mainnet,
    #                            [inputs["utxoMultisig"]],
    #                            [outputs["externalByronMainnet"]],
    #                            42,
    ...
    #                expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED,
    #                additionalWitnessPaths=["m/1852'/1815'/0'/0/0"]),
    # SignTxTestCase("Multisig_spending_path_in_Pool_Registration_(Owner)_Tx",
    #                Transaction(Mainnet,
    #                            [inputs["utxoMultisig"]],
    #                            [outputs["externalByronMainnet"]],
    #                            42,
    ...
    #                expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED,
    #                additionalWitnessPaths=["m/1854'/1815'/0'/0/0"]),
    # SignTxTestCase("Multisig_staking_path_in_Pool_Registration_(Owner)_Tx",
    #                Transaction(Mainnet,
    #                            [inputs["utxoMultisig"]],
    #                            [outputs["externalByronMainnet"]],
    #                            42,
    ...
    #                expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED,
    #                additionalWitnessPaths=["m/1854'/1815'/0'/2/0"]),
    # SignTxTestCase("Mint_path_in_Pool_Registration_(Owner)_Tx",
    #                Transaction(Mainnet,
    #                            [inputs["utxoMultisig"]],
    #                            [outputs["externalByronMainnet"]],
    #                            42,
    ...
    #                expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED,
    #                additionalWitnessPaths=["m/1855'/1815'/0'"]),
    # SignTxTestCase("Pool_cold_path_in_Pool_Registration_(Owner)_Tx",
    #                Transaction(Mainnet,
    #                            [inputs["utxoMultisig"]],
    #                            [outputs["externalByronMainnet"]],
    #                            42,
    ...
    #                expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED,
    #                additionalWitnessPaths=["m/1853'/1815'/0'/0'"]),
    # SignTxTestCase("Multisig_account_path_in_Pool_Registration_(Operator)_Tx",
    #                Transaction(Mainnet,
    #                            [inputs["utxoShelley"]],
    #                            [outputs["externalByronMainnet"]],
    #                            42,
    ...
    #                expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED,
    #                additionalWitnessPaths=["m/1854'/1815'/0'"]),
    # SignTxTestCase("Multisig_spending_path_in_Pool_Registration_(Operator)_Tx",
    #                Transaction(Mainnet,
    #                            [inputs["utxoShelley"]],
    #                            [outputs["externalByronMainnet"]],
    #                            42,
    ...
    #                expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED,
    #                additionalWitnessPaths=["m/1854'/1815'/0'/0/0"]),
    # SignTxTestCase("Ordinary_staking_path_in_Pool_Registration_(Operator)_Tx",
    #                Transaction(Mainnet,
    #                            [inputs["utxoShelley"]],
    #                            [outputs["externalByronMainnet"]],
    #                            42,
    ...
    #                expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED,
    #                additionalWitnessPaths=["m/1852'/1815'/0'/2/0"]),
    # SignTxTestCase("Multisig_staking_path_in_Pool_Registration_(Operator)_Tx",
    #                Transaction(Mainnet,
    #                            [inputs["utxoShelley"]],
    #                            [outputs["externalByronMainnet"]],
    #                            42,
    ...
    #                expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED,
    #                additionalWitnessPaths=["m/1854'/1815'/0'/2/0"]),
    # SignTxTestCase("Mint_path_in_Pool_Registration_(Operator)_Tx",
    #                Transaction(Mainnet,
    #                            [inputs["utxoShelley"]],
    #                            [outputs["externalByronMainnet"]],
    #                            42,
...
testsInvalidTokenBundleOrdering: List[SignTxTestCase] = [
    ...
    #                "",
    #                expected_sw=StatusWord.SWO_INVALID_DATA),
    # SignTxTestCase("Reject tx where_tokens_within_an_asset_group_are_not_ordered_-_alphabetical",
    #                Transaction(Mainnet,
    #                            [inputs["utxoShelley"]],
    ...
    #                "",
    #                expected_sw=StatusWord.SWO_INVALID_DATA),
    # SignTxTestCase("Reject tx where_tokens_within_an_asset_group_are_not_ordered_-_length",
    #                Transaction(Mainnet,
    #                            [inputs["utxoShelley"]],
    ...
    #                "",
    #                expected_sw=StatusWord.SWO_INVALID_DATA),
    # SignTxTestCase("Reject tx_with_mint_fields_with_invalid_canonical_ordering_of_asset_names",
    #                Transaction(Mainnet,
    #                            [inputs["utxoShelley"]],
    #                            [],
    #                            42,
...
#                    additionalWitnessPaths=["m/1852'/1815'/0'/2/0",
#                                            "m/1854'/1815'/0'/2/0"]),
#    SignTxTestCase("Invalid_numerator-denominator_relationship",
#                    Transaction(Mainnet,
#                                [inputs["utxoNoPath"]],
#                                [outputs["externalShelleyBaseKeyhashKeyhash"]],
#                                42,
...
stakePoolRegistrationOwnerRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Non-staking_path_for_Pool_Registration_Owner_Tx",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                               [outputs["externalShelleyBaseKeyhashKeyhash"]],
                               42,
...
outputRejectTestCases: List[SignTxTestCase] = [
    SignTxTestCase("Pool_operator_-_datum_hash",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_operator_-_datum_inline",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                               [outputs["inlineDatum480Map"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_operator_-_reference_script",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_owner_-_datum_hash",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                               [outputs["datumHashExternalMap"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_owner_-_datum_inline",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                               [outputs["inlineDatum480Map"]],
                               42,
                   ...
                   "",
                   expected_sw=StatusWord.SWO_SECURITY_CONDITION_NOT_SATISFIED),
    SignTxTestCase("Pool_owner_-_reference_script",
                   Transaction(Mainnet,
                               [inputs["utxoNoPath"]],
                               [outputs["refScriptExternalMap"]],
                               42,
