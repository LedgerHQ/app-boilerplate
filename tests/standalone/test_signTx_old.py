...
from standalone.input_files.derive_address import AddressType
from standalone.input_files.signTx import MAX_SIGN_TX_CHUNK_SIZE, SignTxTestCase, DeriveAddressTestCase, ThirdPartyAddressParams
from standalone.input_files.signTx import AssetGroup, TxAuxiliaryDataCIP36, TxOutputBabbage
from standalone.input_files.signTx import CertificateType, CredentialParamsType, DRepParamsType, VoterType, TxOutputDestinationType
from standalone.input_files.signTx import TxAuxiliaryDataType, CIP36VoteDelegationType, TransactionSigningMode, DatumType
from standalone.input_files.signTx import DRepUpdateParams, DRepRegistrationParams, StakeRegistrationConwayParams
from standalone.input_files.signTx import ResignCommitteeParams, AuthorizeCommitteeParams, VoteDelegationParams
from standalone.input_files.signTx import testsByron, testsShelleyNoCertificates, testsShelleyWithCertificates
from standalone.input_files.signTx import testsConwayWithCertificates, testsMultisig, testsAllegra, testsMary
from standalone.input_files.signTx import testsAlonzoTrezorComparison, testsBabbageTrezorComparison
from standalone.input_files.signTx import testsMultidelegation, testsConwayWithoutCertificates, testsConwayVotingProcedures
from standalone.input_files.signTx import testsCatalystRegistration, testsCVoteRegistrationCIP36, testsAlonzo, testsBabbage
from standalone.input_files.signTx import poolRegistrationOwnerTestCases, poolRegistrationOperatorTestCases
from standalone.input_files.signTx import transactionInitRejectTestCases, addressParamsRejectTestCases, certificateStakingRejectTestCases
from standalone.input_files.signTx import withdrawalRejectTestCases, witnessRejectTestCases, testsInvalidTokenBundleOrdering
from standalone.input_files.signTx import singleAccountRejectTestCases, collateralOutputRejectTestCases, testsCVoteRegistrationRejects
from standalone.input_files.signTx import certificateRejectTestCases, certificateStakePoolRetirementRejectTestCases
from standalone.input_files.signTx import poolRegistrationOwnerRejectTestCases, invalidCertificates, invalidPoolMetadataTestCases
from standalone.input_files.signTx import invalidRelayTestCases, stakePoolRegistrationPoolIdRejectTestCases
from standalone.input_files.signTx import stakePoolRegistrationOwnerRejectTestCases, outputRejectTestCases
...
def _signTx_init(device: Device,
                 navigator: Navigator,
...
def _signTx_setAuxiliaryData(device: Device,
                             navigator: Navigator,
                             scenario_navigator: NavigateWithScenario,
                             client: CommandSender,
...
def _signTx_addOutputs(device: Device,
                       navigator: Navigator,
                       scenario_navigator: NavigateWithScenario,
                       client: CommandSender,
                       testCase: SignTxTestCase,
...
def _signTx_setFee(device: Device,
                   navigator: Navigator,
                   client: CommandSender,
                   testCase: SignTxTestCase) -> None:
    """Sign TX Set FEE
...
def _signTx_setCertificates(device: Device,
                            navigator: Navigator,
                            scenario_navigator: NavigateWithScenario,
                            client: CommandSender,
                            testCase: SignTxTestCase) -> None:
...
def _signTx_addTokenBundle(device: Device,
                           navigator: Navigator,
                           client: CommandSender,
                           p1: P1Type,
    ...
    moves = [NavInsID.BOTH_CLICK] * 2 if device.is_nano else [NavInsID.TAPPABLE_CENTER_TAP] * 2
...
def _signTx_setMint(device: Device,
                    navigator: Navigator,
                    scenario_navigator: NavigateWithScenario,
                    client: CommandSender,
                    testCase: SignTxTestCase) -> None:
    ...
    moves = [NavInsID.BOTH_CLICK] if device.is_nano else [NavInsID.SWIPE_CENTER_TO_LEFT] * 2
...
def _signTx_addVoterVotes(device: Device,
                          navigator: Navigator,
                          scenario_navigator: NavigateWithScenario,
                          client: CommandSender,
                          testCase: SignTxTestCase) -> None:
...
def _signTx_addCollateralOutputs(device: Device,
                                 navigator: Navigator,
                                 scenario_navigator: NavigateWithScenario,
                                 client: CommandSender,
                                 testCase: SignTxTestCase) -> None:
...
def _signTx_addTotalCollateral(device: Device,
                               navigator: Navigator,
                               client: CommandSender,
                               testCase: SignTxTestCase) -> None:
...
def _signTx_addTreasury(device: Device,
                        navigator: Navigator,
                        client: CommandSender,
                        testCase: SignTxTestCase) -> None:
...
def _signTx_addDonation(device: Device,
                        navigator: Navigator,
                        client: CommandSender,
                        testCase: SignTxTestCase) -> None:
...
def _signTx_confirm(device: Device,
                    navigator: Navigator,
                    scenario_navigator: NavigateWithScenario,
                    client: CommandSender,
...
def _signTx_setWitnesses(device: Device,
                         navigator: Navigator,
                         scenario_navigator: NavigateWithScenario,
                         client: CommandSender,
                         testCase: SignTxTestCase,
