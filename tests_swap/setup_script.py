...
if not os.path.exists("exchange_binaries"):
    ...
    for e in DEVICES_CONF.values():
        ...
        run_cmd("cp "+e["bin_path"]+"app.elf ../exchange_binaries/exchange_"+e["name"]+".elf", Path(APP_EXCHANGE_DIR))
